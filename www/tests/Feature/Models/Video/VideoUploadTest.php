...
class VideoUploadTest extends BaseVideoTestCase {
    ...
    public function test_UploadWithFiles() {
        Storage::fake();
    ...
    public function test_UpdateIfRollbackFiles() {
        Storage::fake();
    ...
    public function  test_FileUrlsWithLocalDriver() {
        $fileFields = [];
    ...
    public function test_FileUrlsIfNullWhenFieldsAreNull() {
        $video = Video::factory()->create();
